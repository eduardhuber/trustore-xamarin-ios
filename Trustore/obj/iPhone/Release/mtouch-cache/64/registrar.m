...
@implementation __MonoMac_NSActionDispatcher { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, 0x4B802);
	}
@end
...
@implementation UIKit_UIControlEventProxy { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, 0x63102);
	}
...
@implementation __UIGestureRecognizerParameterlessToken { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, 0x49F02);
	}
@end
...
@implementation __UIGestureRecognizerParametrizedToken { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_27 (self, _cmd, &managed_method, p0, 0x4A002);
	}
@end
...
@implementation __NSObject_Disposer { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_28 (self, _cmd, &managed_method, p0, 0x4E302);
	}
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_8 (self, _cmd, &managed_method, &call_super, 0x4E102);
		if (call_super && rv) {
			struct objc_super super = {  rv, [NSObject class] };
			rv = ((id (*)(objc_super*, SEL)) objc_msgSendSuper) (&super, @selector (init));
		}
...
@implementation __UILongPressGestureRecognizer { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_29 (self, _cmd, &managed_method, p0, 0x5FA02);
	}
@end
...
@implementation __UIRotationGestureRecognizer { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_30 (self, _cmd, &managed_method, p0, 0x63E02);
	}
@end
...
@implementation __UITapGestureRecognizer { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_31 (self, _cmd, &managed_method, p0, 0x64202);
	}
@end
...
@implementation __UIPanGestureRecognizer { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_32 (self, _cmd, &managed_method, p0, 0x64602);
	}
@end
...
@implementation __UIPinchGestureRecognizer { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_33 (self, _cmd, &managed_method, p0, 0x64A02);
	}
@end
...
@implementation __UISwipeGestureRecognizer { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_34 (self, _cmd, &managed_method, p0, 0x64E02);
	}
@end
...
@implementation __UIScreenEdgePanGestureRecognizer { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_35 (self, _cmd, &managed_method, p0, 0x65202);
	}
@end
